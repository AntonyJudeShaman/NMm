      ...
      ><Navbar/>
        ...
        {!session && showLogin && (
          ...
          <div className="p-4 ">
            ...
            >
              <div className="container flex text-black flex-col items-center gap-4 text-center">
                <h1
                  className="font-heading text-orange-600 text-5xl  md:text-8xl "
                >
                  To-Do List
                </h1>
                <p
                  className="max-w-[42rem] font-bold text-black leading-normal sm:text-xl sm:leading-8"
                  style={{ color: "", fontSize: "2.5vh" }}
                >
                ...
                <div className="space-x-4 mt-4">
                  <Link
                    ...
                    className="btn-black p-4 mb-4 bg-blue-600 hover:bg-blue-500"
                  >
                    GitHub
                  </Link>
                </div>
                <table
                  className="border-collapse  border w-full mt-4"
                  style={{
                    minWidth: 250,
                    maxWidth: 800,
                    margin: "auto",
            ...
            <section
              id="features"
              className="container space-y-6   dark:bg-transparent md:py-12"
            >
              <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                <h2 className="font-heading font-bold text-orange-600  text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
                  Features
                </h2>
              </div>
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-2">
                ...
                >
                  <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-bold text-lg text-orange-600">To-Do List</h3>
                ...
                >
                  <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                    <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current text-black">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-bold text-lg text-orange-600">React</h3>
                      <p className=" text-black">
                ...
                >
                  <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-bold text-lg text-orange-600 ">Database</h3>
                      <p className=" text-black">
                ...
                >
                  <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-bold text-lg text-orange-600">Authentication</h3>
                      <p className=" text-black">
